 ...
 * variations
 * outside of the DeletePersonCommand code. For example, inputs "1" and "1 abc"
 * take the
 * same path through the DeletePersonCommand, and therefore we test only one of
 * them.
    ...
    public void parse_invalidArgs_throwsParseException() {
        assertParseFailure(parser, "a",
                String.format(MESSAGE_INVALID_COMMAND_FORMAT,
                        MESSAGE_INVALID_INDEX + System.lineSeparator() + DeletePersonCommand.MESSAGE_USAGE));
    }
}
